...
void loop(void)
{
  ...
  if (animationState == 1 && packetbuffer[1] == 'B') { // button labeled "1" in control pad
  ...
  if (animationState == 2 && packetbuffer[1] == 'B') { // button labeled "2" in control pad
    for (uint16_t i = 0; i < pixel.numPixels(); i++) { //clear all pixels before displaying new animation
      pixel.setPixelColor(i, pixel.Color(0, 0, 0));
    }
  ...
  if (animationState == 3 && packetbuffer[1] == 'B') { // button labeled "3" in control pad
    for (uint16_t i = 0; i < pixel.numPixels(); i++) { //clear all pixels before displaying new animation
      pixel.setPixelColor(i, pixel.Color(0, 0, 0));
    }
  ...
  if (animationState == 4 && packetbuffer[1] == 'B') { // button labeled "4" in control pad
    for (uint16_t i = 0; i < pixel.numPixels(); i++) { //clear all pixels before displaying new animation
      pixel.setPixelColor(i, pixel.Color(0, 0, 0));
    }
    rainbowCycle(20);
